import pj from '../images/speakers/Premlata_Jena.jpg';
import sns from '../images/speakers/SN_Singh.jpg';
import pb from '../images/speakers/Prabodh_Bajpai.jpg';
...
export const MainSpeaker = {
    ...
    description: 'Chief Engineer, Central Electricity Authority (CEA) <br/>Visiting Prof IIT Kanpur',
...
const Speakers = [
...

    {
        ...
        description: 'IIT Kanpur',
        bio:"Parthasarathi Sensarma (Senior Member, IEEE) received the B.E.E degree from Jadavpur University, Kolkata, India, in 1990, the M.Tech degree from the Indian Institute of Technology (IIT) Kharagpur, Kharagpur, India, in 1992, and the Ph.D. degree from Indian Institute of Science Bangalore, Bangalore, India, in 2001, all in electrical engineering.,He had held positions at Bharat Bijlee Ltd., Thane, India; CESC Ltd., India; and ABB Corporate Research, Baden-Daettwil, Switzerland, where he was a Scientist in the Power Electronics Department. Since 2002, he has been with the Department of Electrical Engineering, IIT Kanpur, Kanpur, India, where he is currently a Professor. He teaches courses on power electronics and electrical engineering. His research interests include electrical machines and drives, power quality, flexible ac transmission system devices, power converters, and renewable energy integration.",
        imageSrc: ps
    },
    {
    ...
    },
    {
        ...
        title: 'Prof. Ranjan Kumar Behra',
        description: 'IIT Patna',
        bio:"Prof. Ranjan Kumar Behera  received the Ph.D. degree in electrical engineering from Indian Institute of Technology (IIT) Kanpur, Kanpur, India, in 2009. He is currently an  Proffesor with Department of Electrical Engineering Indian Institute of Technology Patna. His research interests include Power Electronics Circuits, Control of Electrical Drives, Application of Nonlinear Control Theory to Power Electronics and Electric Drives, Pulse Width Modulation Techniques for Power Electronics, Renewal Energy Integration.",
        imageSrc: rkb,
    },
    {
